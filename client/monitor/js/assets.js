...
var assets = {
    ...
    ui: [
        ['logo', '/static/monitor/assets/logo.png', 589, 329],
        ['ui-overlay', '/static/monitor/assets/ui-overlay.png', 800, 500]
    ],
    // Format is [key, path, width, height]
    images: [
        ...
        ['floor', '/static/monitor/assets/floor.png', 64, 32],
        ['walls', '/static/monitor/assets/walls.png', 32, 32],
        ['player', '/static/monitor/assets/player.png', 64, 64],
        ['hazards', '/static/monitor/assets/hazards.png', 160, 32],
        ['exit', '/static/monitor/assets/exit.png', 32, 32]
    ],
    // Audio files to load
    sounds: [
