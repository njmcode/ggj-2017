var ElementFactory = (function() {
  ...
  function VisorFloor(renderer) {
    var geo = new THREE.PlaneGeometry(1000, 1000);

    var texture = THREE.ImageUtils.loadTexture(
    '/static/visor/assets/textures/patterns/dots2.png'
    );
  ...
  function VisorHUDLower(renderer) {
    var geo = new THREE.PlaneGeometry(11.2, 2.5);
    var texture = THREE.ImageUtils.loadTexture(
      '/static/visor/assets/hudtex/hud-bottom.png'
    );
    texture.anisotropy = renderer.getMaxAnisotropy();
  ...
  function VisorHUDUpper(renderer) {
    var geo = new THREE.PlaneGeometry(11.2, 2.5);
    var texture = THREE.ImageUtils.loadTexture(
      '/static/visor/assets/hudtex/hud-top.png'
    );
    texture.anisotropy = renderer.getMaxAnisotropy();
